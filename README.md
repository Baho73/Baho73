...
Пайплайн аудиотранскрибации: распознавание речи (WhisperX), диаризация спикеров, анализ эмоций. Готовый инструмент для обработки аудиозаписей совещаний и интервью.
...
Дашборд строительных проектов с EVM-анализом (Earned Value Management). Визуализация прогресса, отклонений по срокам и бюджету.
`Python` `HTML`
