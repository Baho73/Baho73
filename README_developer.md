...
Спецификация интерфейса v1.2 прошла разбор по FPF (First Principles Framework, открытая методология проверки спецификаций; 12 P0 закрыты); 5 противоречий разрешены по ТРИЗ. Перечень зависимостей с лицензиями прикладывается к каждой сдаче.
