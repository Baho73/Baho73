...
Under the hood: OpenAI Realtime as the dialogue engine, Twilio for telephony, FastAPI, a persistent queue, signed webhooks with retries. The v1.2 interface specification went through an FPF pass (First Principles Framework, an open specification-hardening methodology; 12 critical gaps closed). Five contradictions resolved with TRIZ. Dependencies with verified licenses, CC0 backgrounds. Logs contain neither phone numbers nor conversation text.
